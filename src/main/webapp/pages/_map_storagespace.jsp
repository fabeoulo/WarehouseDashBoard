...
<script>
    ...
    function resetBlub(obj) {
        obj.removeAttr("title").off("click");
    }
    function setBlubClass(obj, blubClass) {
        obj.removeClass("blub-empty blub-alarm blub-normal blub-abnormal blub-target")
                .addClass(blubClass);
    }
    ...
    $(function () {
        ...
        function storageSpaceToWiget(obj) {
            ...
            for (var k = 0, l = obj.length; k < l; k++) {
                ...
                var isTarget = thisDiv.hasClass("blub-target");
                if (!isTarget || (isTarget && alarmSignal !== 0)) {
                    setBlubClass(thisDiv, signalClass);
                }
